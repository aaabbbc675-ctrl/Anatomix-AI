...
// پس باید فایل‌های موتور را با dynamic import() بارگذاری کند.
let passCount = 0;
let failCount = 0;
...
(async () => {
  const { applyTrainingTechnique } = await import("../engine/bodybuilding/file4_trainingSystem/eligibility.js");
  const { filterExercisesByInjuryBlacklist } = await import("../engine/bodybuilding/file4_trainingSystem/injuryFilter.js");
  const { applyGenderExerciseWeighting } = await import("../engine/bodybuilding/file4_trainingSystem/genderExerciseWeighting.js");
  const { parseEccentricSeconds } = await import("../engine/bodybuilding/file4_trainingSystem/tempoRule.js");
